...
BEGIN
  ...
  INSERT INTO lessons (module_id, course_id, title, content, "order", duration_minutes, chess_board_fen) VALUES
    ...
    (m1, course_id, 'Урок 2: Как ходит пешка', 'Пешка ходит на одну клетку вперёд (на два с начальной позиции). Бьёт по диагонали на одну клетку.', 2, 12, '8/8/8/4p3/8/8/8/8 w - - 0 1'),
    ...
    (m1, course_id, 'Урок 4: Как ходит конь', 'Конь ходит буквой "Г": 2 клетки в одном направлении и 1 в перпендикулярном. Может перепрыгивать через фигуры.', 4, 12, '8/8/8/4n3/8/8/8/8 w - - 0 1');

  -- Module 2 lessons
  INSERT INTO lessons (module_id, course_id, title, content, "order", duration_minutes, chess_board_fen) VALUES
    (m2, course_id, 'Урок 5: Как ходит ладья', 'Ладья ходит по горизонтали и вертикали на любое число клеток. Сильнее всего на открытых вертикалях.', 5, 10, '8/8/8/4r3/8/8/8/8 w - - 0 1'),
    (m2, course_id, 'Урок 6: Как ходит ферзь', 'Ферзь — самая сильная фигура. Ходит как ладья + слон: по горизонтали, вертикали и диагонали.', 6, 12, '8/8/8/4q3/8/8/8/8 w - - 0 1'),
    (m2, course_id, 'Урок 7: Король — главная фигура', 'Король ходит на одну клетку в любом направлении. Игра заканчивается, когда королю ставят мат.', 7, 10, '8/8/8/4k3/8/8/8/8 w - - 0 1');
