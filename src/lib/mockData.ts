    ...
    modules: [
      ...
      },
      {
        ...
        lessons: [
          {
            id: 'l8',
            title: 'Урок 8: Шах и мат',
            content: 'Шах — нападение на короля. Мат — шах, от которого некуда деться. Цель игры — поставить мат.',
            order: 8,
            duration_minutes: 15,
          ...
          {
            id: 'l9',
            title: 'Урок 9: Основные правила',
            content: 'Рокировка, взятие на проходе, превращение пешки — ключевые правила шахмат.',
            order: 9,
            duration_minutes: 15,
            chess_board_fen: 'r3k2r/pppppppp/8/8/8/8/PPPPPPPP/R3K2R w KQkq - 0 1',
          },
          {
            id: 'l10',
            title: 'Урок 10: Первая партия',
            content: 'Поздравляю! Ты готов сыграть свою первую партию. Вспомни все фигуры и поставь мат.',
            order: 10,
            duration_minutes: 20,
            chess_board_fen: 'rnbqkbnr/pppppppp/8/8/4P3/8/PPPP1PPP/RNBQKBNR b KQkq - 0 1',
          },
        ]
      },
    ]
