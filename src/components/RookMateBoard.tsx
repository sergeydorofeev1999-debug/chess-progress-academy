...
const EXERCISES: Exercise[] = [
  {
    ...
    demoMoves: [
      ...
      { from: 'd5', to: 'c5', comment: 'Чёрный король отступает' },
      { from: 'e4', to: 'd4', comment: 'Ладья продолжает давить' },
      { from: 'c5', to: 'b5', comment: 'Король бежит влево' },
      { from: 'd4', to: 'c4', comment: 'Ладья сужает пространство' },
      { from: 'b5', to: 'b6', comment: 'Король отступает назад' },
      { from: 'd3', to: 'd4', comment: 'Белый король приближается' },
      { from: 'b6', to: 'b5', comment: 'Чёрный король пытается уйти' },
      { from: 'd4', to: 'd5', comment: 'Белый король продолжает наступление' },
      { from: 'b5', to: 'b6', comment: 'Король отступает' },
      { from: 'c4', to: 'c5', comment: 'Ладья даёт шах!' },
      { from: 'b6', to: 'b7', comment: 'Король уходит на 7-ю линию' },
      { from: 'c5', to: 'c6', comment: 'Ладья сужает пространство' },
      { from: 'b7', to: 'b8', comment: 'Король на край доски' },
      { from: 'd5', to: 'd6', comment: 'Белый король приближается' },
      { from: 'b8', to: 'b7', comment: 'Король пытается уйти' },
      { from: 'd6', to: 'd7', comment: 'Белый король наступает' },
      { from: 'b7', to: 'b8', comment: 'Король вынужден на край' },
      { from: 'c6', to: 'c7', comment: 'Ладья даёт шах!' },
      { from: 'b8', to: 'a8', comment: 'Король в угол' },
      { from: 'd7', to: 'c6', comment: 'Белый король поддерживает' },
      { from: 'a8', to: 'b8', comment: 'Король пытается уйти' },
      { from: 'c6', to: 'b6', comment: 'Белый король сужает пространство' },
      { from: 'b8', to: 'a8', comment: 'Король в углу' },
      { from: 'c7', to: 'c8', comment: 'Мат!' },
    ],
    minMoves3: 14,
    minMoves2: 16,
  },
